...
public class LowestCommonAncestorTest {
    ...
    void testClassicExample_5And1() {
        ...
        TreeNode result = lca.lowestCommonAncestor(root, node5, node1);
    ...
    void testClassicExample_5And4() {
        ...
        TreeNode result = lca.lowestCommonAncestor(root, node5, node4);
    ...
    void testClassicExample_6And4() {
        ...
        TreeNode result = lca.lowestCommonAncestor(root, node6, node4);
        assertEquals(5, result.val);
    }
    ...
    void testTwoNodeTree() {
        ...
        TreeNode result = lca.lowestCommonAncestor(root, root, left);
        assertEquals(1, result.val);

        // LCA of child and root should be root
        TreeNode result2 = lca.lowestCommonAncestor(root, left, root);
    ...
    void testLinearTree() {
        ...
        TreeNode result = lca.lowestCommonAncestor(node1, node1, node4);
        assertEquals(1, result.val);

        // LCA of 2 and 4 should be 2
        TreeNode result2 = lca.lowestCommonAncestor(node1, node2, node4);
        assertEquals(2, result2.val);

        // LCA of 3 and 4 should be 3
        TreeNode result3 = lca.lowestCommonAncestor(node1, node3, node4);
    ...
    void testSameNode() {
        ...
        TreeNode result = lca.lowestCommonAncestor(root, left, left);
        assertEquals(5, result.val);
    }
