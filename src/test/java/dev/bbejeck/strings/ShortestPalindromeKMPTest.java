...
/**
 * Unit tests for the ShortestPalindromeKMP class
 */
public class ShortestPalindromeKMPTest {

    private ShortestPalindromeKMP palindromeFinder;

    @BeforeEach
    void setUp() {
        palindromeFinder = new ShortestPalindromeKMP();
    }
